...
class CaseStudies {
  ...
  constructor() {
    ...
    this.allCaseStudies = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#all_case_studies");
    this.csPagination = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#cs_pagination");
    this.csPaginationLink = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".page-numbers");
    this.caseStudyDropdown = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".case_study_dropdown");
    this.caseStudies = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#case_studies");
    this.events();
  } // 2. EVENTS.


  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("click", "a.page-numbers", this.loadCaseStudies.bind(this)); // this refers to the class (".page-numbers")
  ...
  loadCaseStudiesDropdown(e) {
    let $cat = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target[e.target.selectedIndex]).data("cat");
    let $tax = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target[e.target.selectedIndex]).data("tax");
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).val($cat);
  ...
  loadCaseStudies(e) {
    e.preventDefault();
    let $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target.closest("a.page-numbers"));
  ...
  ajaxRequest(params) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1__["default"].post(pmapiAdditionalData.pmapi_app_root + "/wp-admin/admin-ajax.php", params).then(res => {
